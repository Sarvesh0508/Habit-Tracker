    ...
    <style>
        ...
        * {
        ...
        .header-nav-tab.active {
            ...
            box-shadow: 0 2px 10px rgba(255,74,90,0.35);
        }
        .timer-svg {
...
<body>
    ...
    <header class="netflix-header" id="mainHeader" style="position: fixed; top: 0; left: 0; right: 0; height: 75px; z-index: 1000; background: #0d0f12; border-bottom: 1px solid #20252e; padding: 0 50px; display: flex; justify-content: space-between; align-items: center; box-sizing: border-box;">
        <!-- Logo (left) -->
        <div style="display: flex; align-items: center; cursor: pointer; flex-shrink: 0;" onclick="switchTabDirect('home')">
            <span style="font-family: 'Outfit', sans-serif; font-size: 1.6rem; font-weight: 800; color: #ff4a5a; text-transform: uppercase; letter-spacing: 2px; user-select: none;">STREAK7</span>
        </div>

        <!-- Nav Tabs (center) -->
        <div class="header-nav" style="display: flex; gap: 6px; align-items: center;">
        ...
        <div style="display: flex; align-items: center; gap: 10px; flex-shrink: 0;">
            <div id="headerAvatar" style="width: 38px; height: 38px; border-radius: 50%; background: #ff4a5a; color: #fff; border: 2px solid rgba(255,255,255,0.3); display: flex; align-items: center; justify-content: center; font-weight: 800; font-size: 1rem; cursor: pointer; font-family: 'Outfit', sans-serif;" onclick="switchTabDirect('profile')">G</div>
        </div>
    </header>
    ...
    <div class="tab-content active" id="home-tab">
        ...
        <div class="dashboard-hero" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px; padding: 10px 0; border-bottom: 1px solid rgba(255,255,255,0.05); padding-bottom: 20px;">
            ...
            <div style="display:flex;align-items:center;gap:12px;flex-shrink:0;">
                <span id="heroBadge" style="background:#ff4a5a;color:#fff;padding:5px 14px;border-radius:20px;font-weight:800;font-size:0.85rem;font-family:'Outfit',sans-serif;">Level 1</span>
                <button onclick="resetAllData()" style="background:transparent;border:2px solid #ff4a5a;color:#ff4a5a;padding:9px 18px;border-radius:6px;font-size:0.8rem;font-weight:700;cursor:pointer;transition:all 0.2s;display:flex;align-items:center;gap:6px;" onmouseover="this.style.background='#ff4a5a';this.style.color='#fff'" onmouseout="this.style.background='transparent';this.style.color='#ff4a5a'"><i class="fas fa-rotate-left"></i> RESET DATA</button>
            </div>
        </div>
    ...
    <script>
        ...
        // Always hide overlay after 4 seconds as failsafe
        setTimeout(() => {
            const ov = document.getElementById('loadingOverlay');
            if (ov) { ov.style.opacity='0'; ov.style.pointerEvents='none'; setTimeout(()=>ov.remove(),500); }
        }, 4000);
...
const profileEmailDetail = document.getElementById('profileEmailDetail');
        ...
        function resetAllData() {
            ...
            localStorage.removeItem('streak7_app_state');
            localStorage.clear();
            location.reload();
        }
        // ───────────────────────────────────────────────────────────────
